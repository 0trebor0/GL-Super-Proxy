...
namespace SupercellProxy
{
    class WebAPI
    {
        ...
        private static String URI = "http://178.32.9.216:" + 8080 + "/";
                        ...
                        ThreadPool.QueueUserWorkItem((c) =>
                        {
                            ...
                            byte[] responseBuf =
                                Encoding.UTF8.GetBytes(
                                    "{\"assetUrl\":\"http:\\/\\/cc59c497466f75d53319-2fdc8ba9850fc65de50e260bf74507bd.r73.cf2.rackcdn.com\\/\",\"environment\":\"prod\",\"status\":\"success\",\"serverHost\":\"gamea.haydaygame.com\"}");
